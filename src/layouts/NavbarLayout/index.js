...
import NavbarDropdown from "layouts/NavbarLayout/NavbarDropdown";
import NavbarMobile from "layouts/NavbarLayout/NavbarMobile";
    ...
    <Container sx={sticky ? { position: "sticky", top: 0, zIndex: 10 } : null}>
      ...
      >
        <MKBox display="flex" justifyContent="space-between" alignItems="center">
          ...
          >
            <Icon fontSize="default">{mobileNavbar ? "close" : <MenuIcon/>}</Icon>
          </MKBox>
        </MKBox>
        <MKBox
